...
export const prompt: string = `You are an expert data processor. Your task is to categorize bank transactions by matching the business name from a bank statement to a known list of businesses.

                    ...
                    <div className="bg-white p-6 rounded-lg shadow-2xl w-full max-w-lg text-center relative">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-3 bg-blue-500 text-white rounded-lg flex items-center gap-3 justify-center hover:bg-blue-700 transition shadow-md border border-blue-500"
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-3 bg-green-600 text-white rounded-lg flex items-center gap-3 justify-center hover:bg-green-700 transition shadow-md border border-green-500"
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-3 bg-blue-500 text-white rounded-lg flex items-center gap-3 justify-center hover:bg-blue-700 transition shadow-md border border-yellow-400"
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-3 bg-blue-500 text-white rounded-lg flex items-center gap-3 justify-center hover:bg-blue-700 transition shadow-md border border-purple-400"
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-3 bg-blue-500 text-white rounded-lg flex items-center gap-3 justify-center hover:bg-blue-700 transition shadow-md border border-indigo-500"
                            ...
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-3 bg-red-600 text-white rounded-lg flex items-center gap-3 justify-center hover:bg-red-700 transition shadow-md border border-red-500"
                ...
                >
                    <div className="bg-white p-6 rounded-lg shadow-2xl w-full max-w-lg text-center">
                        <AddCategory
                            ...
                            showConfirm={setShowAddCategory}
                        />

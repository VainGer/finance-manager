                                        ...
                                        {isDropdownOpen && (
                                            <div className="absolute right-0 top-full mt-2 w-48 sm:w-52 bg-white rounded-xl shadow-xl py-1 z-[2100] border border-gray-200">
                                                ...
                                                <button
                                                    ...
                                                    className={`block w-full text-right px-3 sm:px-4 py-3 text-sm text-slate-700 hover:bg-slate-50 transition-colors duration-200 ${profile ? 'border-t border-gray-200' : ''}`}
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <svg className="w-4 h-4 flex-shrink-0 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12H3m0 0l4-4m-4 4l4 4m4-9h10a2 2 0 012 2v10a2 2 0 01-2 2H11a2 2 0 01-2-2v-1" />
                                                        </svg>
                                                        <span className="font-medium">החלף פרופיל</span>
                                                    </div>
                                                </button>
                                                <button

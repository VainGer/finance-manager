            ...
            <div className="bg-white/95 backdrop-blur-lg rounded-2xl border border-white/20 shadow-xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 text-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold">תובנות AI מבוססות תקציב</h2>
                ...
                <div className="p-12 text-center">
                    ...
                    <div className="text-xl font-bold text-slate-600 mb-3">אין דוחות ניתוח להצגה כרגע</div>
                    <div className="text-slate-500 mb-6">האינטלגנציה המלאכותית תנתח את ההוצאות שלך ותציג תובנות מועילות</div>
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 rounded-lg text-sm text-indigo-700">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        הניתוח יהיה זמין לאחר מספר הוצאות
                    </div>
                </div>
            </div>
        );
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-lg font-bold text-green-900">ניתוח קטגוריות</h3>
                    </div>
                        ...
                        {categories.map((cat, idx) => (
                            <div key={idx} className="bg-white rounded-lg p-4">
                                ...
                                {cat.actions?.length > 0 && (
                                    <div>
                                        <div className="text-xs font-bold text-slate-700 mb-1">המלצות:</div>
                                        <div className="space-y-1">
                                            {cat.actions.slice(0, 2).map((action, aIdx) => (
                                                <div key={aIdx} className="bg-blue-50 p-2 rounded text-xs">
                                                    <div className="font-semibold text-blue-800">{action.proposal}</div>
                ...
                {nextMonthPlan && (
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-purple-900">תוכנית לחודש הבא</h3>
                        </div>
                ...
                {dataQuality?.length > 0 && (
                    <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-6">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-orange-900">איכות נתונים</h3>
                        </div>

                        ...
                        <ul className="space-y-2">
                            <li>
                                <button 
                                    ...
                                    className="w-full text-right py-2 px-4 rounded-md text-gray-700 bg-gray-100 hover:bg-indigo-100 hover:text-indigo-700 transition-colors flex items-center"
                                >

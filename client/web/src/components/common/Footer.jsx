        ...
        <footer className="bg-slate-900 text-white" dir="rtl">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            {profile ? (
                                ...
                                // אם המשתמש לא מחובר - הצג התחברות והרשמה
                                <>
                                    <li>
                                        <button
                    ...
                    {/* Features */}
                    <div>
                        <h4 className="text-lg font-semibold mb-4">תכונות</h4>
                        <ul className="space-y-2">
                    ...
                    {/* Support */}
                    <div>
                        <h4 className="text-lg font-semibold mb-4">תמיכה ועזרה</h4>
                        <ul className="space-y-2">
                            <li>
                ...
                <div className="border-t border-slate-700 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="text-slate-400 text-sm mb-4 md:mb-0">
                            © 2025 Smart Finance. כל הזכויות שמורות.
                        </div>

...
import useEditCategories from './useEditCategories.js';
import useEditBusiness from './useEditBusiness.js';
...
export default function useEditTransactions({ profile, refetchBudgets, refetchExpenses }) {
    ...
    const { getCategories, error: categoryError, success: categorySuccess, loading: categoryLoading } = useEditCategories({ profile });
    const { getBusinesses, error: businessError, success: businessSuccess, loading: businessLoading } = useEditBusiness({ profile });
